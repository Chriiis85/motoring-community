  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 w-full z-[99999] bg-white/95 dark:bg-[#121212]/95 backdrop-blur-md border-b border-slate-200/90 dark:border-gray-800/80 shadow-xs dark:shadow-2xl transition-all duration-300" style={{ zIndex: 99999 }}>
        <div className="w-full max-w-7xl 2xl:max-w-8xl mx-auto h-16 sm:h-20 flex items-center justify-between px-3 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link 
              href="/" 
              aria-label="Motoring Community Home"
          ...
          <nav aria-label="Main Navigation" className="hidden lg:flex items-center gap-1 xl:gap-3 2xl:gap-6 text-xs xl:text-sm font-bold text-slate-700 dark:text-gray-200">
          ...
          <div className="hidden lg:flex items-center gap-3 xl:gap-4 flex-shrink-0">
            ...
            <div className="flex items-center gap-2 pl-3 border-l border-slate-200 dark:border-gray-700/80">
              ...
              <a 
                ...
                aria-label="Visit Christian's GitHub profile"
              >
                <svg aria-hidden="true" className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="-2.5 0 19 19">
              ...
              <a 
                ...
                aria-label="Visit Christian's LinkedIn profile"
              >
                <svg aria-hidden="true" className="w-4 h-4 fill-current" viewBox="0 -2 44 44" xmlns="http://www.w3.org/2000/svg">
        ...
        {isMobileMenuOpen && (
          <div id="mobile-menu" role="region" aria-label="Mobile Navigation Drawer" className="lg:hidden border-t border-slate-200 dark:border-gray-800 bg-white/98 dark:bg-[#161616]/98 backdrop-blur-2xl shadow-2xl p-4 sm:p-6 text-slate-900 dark:text-white flex flex-col gap-2.5 font-['F1Regular'] max-h-[calc(100vh-4rem)] sm:max-h-[calc(100vh-5rem)] overflow-y-auto">
            {/* F1 Accordion */}
            <div className="border-b border-slate-200 dark:border-gray-800 pb-2">
              <button 
                type="button"
                onClick={() => setIsMobileF1SubmenuOpen(!isMobileF1SubmenuOpen)}
                aria-expanded={isMobileF1SubmenuOpen}
                aria-label="Formula One submenu accordion"
              ...
              >
                ...
                <span aria-hidden="true" className={`transform transition-transform duration-200 ${isMobileF1SubmenuOpen ? 'rotate-180' : ''}`}>▼</span>
              </button>
      ...
      {variant === "page" && pageTitle && (
        <section className="w-full min-h-[240px] sm:min-h-[300px] md:min-h-[360px] pt-24 sm:pt-28 pb-8 px-4 flex items-center justify-center text-center relative z-10 overflow-hidden">
          <div 
            className="absolute inset-0 w-full h-full bg-cover bg-center" 
            style={{ backgroundImage: `url('${backgroundImage}')` }}
          />
          <div className="absolute inset-0 w-full h-full bg-black/65 backdrop-blur-[1px]" />
          <h1 className="relative z-10 w-full max-w-5xl text-center text-white text-2xl sm:text-4xl md:text-5xl lg:text-6xl tracking-wider font-[family-name:var(--font-f1-title)] uppercase px-2 leading-tight drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] m-0">
            {pageTitle}
          </h1>
        </section>
      )}
