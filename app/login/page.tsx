  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow flex items-center justify-center relative overflow-hidden bg-[#f3f3f3] min-h-[100vh] py-[10vh]">
        ...
        <section className="relative z-10 w-[90%] md:w-[70%] h-[670px] lg:h-[75vh] min-h-[500px] flex flex-row bg-white border-2 border-black rounded-[15px] shadow-[0_5px_15px_rgba(0,0,0,0.35)]">
          {/* FOTO DEL FORMULARIO */}
          ...
          <article className="w-full md:w-[60%] h-full flex items-center justify-center">
            ...
            >
              ...
              <h1 className="text-[2em] md:text-[2.5em] font-bold text-center mt-2 mb-4 tracking-wide uppercase font-['F1Title']">
                Motoring Community Login
              </h1>

              <div className="relative my-[10px] w-[200px] sm:w-[300px] md:w-[500px]">
                <input 
                  id="usernameLogin" 
                  name="username" 
                  type="text" 
              ...
              <div className="w-[200px] sm:w-[300px] md:w-[500px] flex md:justify-end justify-center mb-4 md:-mt-2">
                <Link 
                  href="/register"
